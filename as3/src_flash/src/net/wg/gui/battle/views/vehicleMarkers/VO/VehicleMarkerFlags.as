...
{
    /** Compact copy of original damage color/type rules. */
    public class VehicleMarkerFlags
    {
        ...
        public static const PLAYER_DAMAGE_COLOR:Object = {
            "green":"gold", "red":"gold", "gold":"gold",
            "blue":"gold", "yellow":"gold", "purple":"gold", "white":"gold"
        };

        public static const SQUAD_DAMAGE_COLOR:Object = {
            "green":"orange", "red":"orange", "gold":"orange",
            "blue":"orange", "yellow":"yellow", "purple":"yellow", "white":"yellow"
        };

        public static const OTHER_DAMAGE_COLOR:Object = {
            "green":"green", "red":"red", "gold":"green",
            "blue":"green", "yellow":"green", "purple":"purple", "white":"white"
        };
        ...
        public static function checkLabeledDamages(type:String) : Boolean
        {
            return type == null || type == "" || LABELED_DAMAGE_TYPES.indexOf(type) != -1;
        }

        public static function checkAllowedDamages(type:String) : Boolean
        {
            return type == null || type == "" || ALLOWED_DAMAGE_TYPES.indexOf(type) != -1;
        }
    }
}
