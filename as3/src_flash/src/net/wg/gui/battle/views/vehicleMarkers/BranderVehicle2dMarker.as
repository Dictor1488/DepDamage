package net.wg.gui.battle.views.vehicleMarkers
{
   ...
   public class BranderVehicle2dMarker extends BaseActionMarker implements IMarkerManagerHandler, IVehicleMarkerInvokable
   {
      ...
      public function updateHealth(param1:int, param2:uint, param3:String, param4:int = -1) : void
      {
         ...
         var _loc6_:int = this._model.currHealth - param1;
         this._model.currHealth = param1;
         if(this._isPopulated)
         {
      ...
      private function updateCriticalLayout() : void
      {
         ...
         var _loc2_:int = _loc1_ ? int(_loc1_.damageLabel.textWidth) : 0;
      ...
      private function updateMarkerSettings() : void
      {
         ...
         var _loc2_:Boolean = this.getIsPartVisible(HEALTH_BAR);
         _loc1_ = this.getIsPartVisible(HEALTH_LBL);
         var _loc3_:Boolean = this.getIsPartVisible(DAMAGE_PANEL);
         if(_loc2_)
         {
            this.healthBar.currHealth = this._model.currHealth;
         }
         this.healthBar.visible = _loc2_;
         this.hpField.visible = _loc1_;
         if(this._vehicleDestroyed)
         {
            this.setDestroyedColorForHP();
         }
         ...
         §§push(this);
         var _temp_2:* = new <Boolean>[_loc2_ || _loc1_,this._model.squadIndex != 0,this.statusContainer.isVisible(),this.actionMarker.isVisible()];
         §§pop().layoutParts(new <Boolean>[_loc2_ || _loc1_,this._model.squadIndex != 0,this.statusContainer.isVisible(),this.actionMarker.isVisible()]);
      }
      ...
      private function layoutParts(param1:Vector.<Boolean>) : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = PARTS_START_Y;
         var _loc5_:int = int(this._markerParts.length);
         ...
         while(_loc9_ < _loc5_)
         {
            _loc2_ = this._markerParts[_loc9_];
            ...
            else
            {
               ...
               if(_loc8_)
               {
                  ...
                  _loc2_.y = _loc4_ - _loc3_ - _loc2_.height | 0;
                  _loc6_ = _loc2_;
                  _loc4_ = _loc2_.y;
               }
            }
      ...
      private function prepareLayout() : void
      {
         ...
         var _loc2_:Array = [this.hpField,this.squadIcon,this.statusContainer,this.actionMarker];
         var _loc3_:Array = [-2,1,0,0];
         var _loc4_:Array = [null,null,null,new CrossOffset(this.statusContainer,-25)];
         var _loc5_:int = int(_loc2_.length);
         var _loc6_:int = 0;
         while(_loc6_ < _loc5_)
         {
            _loc1_ = new VehicleMarkerPart(_loc2_[_loc6_],_loc3_[_loc6_],_loc4_[_loc6_]);
            this._markerParts.push(_loc1_);
            _loc6_++;
         }
