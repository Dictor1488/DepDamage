package net.wg.gui.battle.views.vehicleMarkers
{
   ...
   public class VehicleMarker extends BattleUIComponent implements IMarkerManagerHandler, IVehicleMarkerInvokable
   {
      ...
      protected var offsets:Array = [-2,-2,1,1,1,1,1,0,0,-66];
      ...
      public var _damageAnimState:Boolean = false;
      ...
      public function updateHealth(param1:int, param2:uint, param3:String, param4:int = -1) : void
      {
         ...
         var _loc6_:int = this.model.currHealth - param1;
         this.model.currHealth = param1;
         if(this._isPopulated)
         {
            ...
            {
               if(_loc6_ != Values.ZERO)
               {
                  this.showHitLabelAnim(_loc6_,_loc5_,param2);
               }
         ...
         if(_loc6_ < 0)
         {
            _loc7_ = String("+" + int(Math.abs(_loc6_)));
         }
         else if(_loc6_ > 0)
         {
         ...
         if(_loc7_ != "")
         {
            this.addDamageLabel(param2,_loc7_);
         }
      }
      ...
      protected function updatePartsVisibility() : Vector.<Boolean>
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:Boolean = this.getIsPartVisible(ICON);
         var _loc5_:Boolean = this.getIsPartVisible(LEVEL);
         var _loc6_:Boolean = this.getIsPartVisible(P_NAME_LBL);
         var _loc7_:Boolean = this.getIsPartVisible(V_NAME_LBL);
         var _loc8_:Boolean = this.getIsPartVisible(HEALTH_BAR);
         var _loc9_:Boolean = this.getIsPartVisible(HEALTH_LBL);
         var _loc10_:Boolean = this.getIsPartVisible(DAMAGE_PANEL);
         if(_loc6_ && this._lastPlayerName != this.model.pName)
         {
         ...
         this.playerNameField.visible = _loc6_;
         if(_loc7_)
         {
            this.vehicleNameField.text = this.model.vType;
         }
         this.vehicleNameField.visible = _loc7_;
         if(_loc8_)
         {
            this.healthBar.currHealth = this.model.currHealth;
         }
         this.healthBar.visible = _loc8_;
         this.hpField.visible = _loc9_;
         if(this.vehicleDestroyed)
         {
            this.setDestroyedColorForHP();
         }
         this.setHealthText();
         this.playerHitLabel.visible = _loc10_;
         this.squadHitLabel.visible = _loc10_;
         this.otherHitLabel.visible = _loc10_;
         this.hitExplosion.visible = _loc10_;
         this.criticalHit.visible = _loc10_;
         this.levelIcon.visible = _loc5_;
         this.vehicleIcon.visible = _loc4_;
         var _loc11_:int = (_loc6_ ? 1 : 0) + (_loc7_ ? 1 : 0);
         if(!_loc8_)
         {
            _loc11_ += _loc9_ ? 1 : 0;
            if(_loc11_ > 0)
            {
               _loc11_ += SHADOW_TYPE_HBAR_OFFSET;
            }
         }
         if(_loc11_ > 0)
         {
            _loc2_ = this.getShadowPosition(_loc11_);
            this.vmManager.drawGraphics(VMAtlasItemName.getShadowName(_loc11_),this.bgShadow.graphics,_loc2_);
         ...
         var _temp_3:* = new <Boolean>[_loc8_ || _loc9_,_loc6_,_loc7_,_loc5_,_loc4_,this.model.squadIndex != 0,this._isFlagShown,this.statusContainer.isVisible(),this.actionMarker.isVisible(),this.vehicleMarkerHoverMC.visible];
         var _loc12_:Vector.<Boolean> = new <Boolean>[_loc8_ || _loc9_,_loc6_,_loc7_,_loc5_,_loc4_,this.model.squadIndex != 0,this._isFlagShown,this.statusContainer.isVisible(),this.actionMarker.isVisible(),this.vehicleMarkerHoverMC.visible];
         for each(_loc1_ in this._insertedPartsSorted)
         {
            _loc3_ = this.markerParts.indexOf(_loc1_);
            _loc12_.splice(_loc3_,0,!this.isStickyAndOutOfScreen);
         }
         return _loc12_;
      }
      ...
      private function layoutParts(param1:Vector.<Boolean>) : void
      {
         var _loc2_:VehicleMarkerPart = null;
         var _loc3_:int = 0;
         var _loc4_:int = this.getStartY();
         var _loc5_:int = int(this.markerParts.length);
         var _loc6_:VehicleMarkerPart = null;
         var _loc7_:Boolean = this._canUseCachedVisibility;
         var _loc8_:Boolean = false;
         var _loc9_:int = 0;
         while(_loc9_ < _loc5_)
         {
            _loc2_ = this.markerParts[_loc9_];
            _loc8_ = param1[_loc9_];
            if(_loc7_ && _loc8_ && _loc2_.cachedVisibility == _loc8_)
            {
               _loc4_ = _loc2_.y;
               _loc6_ = _loc2_;
            }
            else
            {
               ...
               if(_loc8_)
               {
                  _loc3_ = _loc2_.offsetFromPart(_loc6_);
                  _loc2_.y = _loc4_ - _loc3_ - _loc2_.height;
                  _loc6_ = _loc2_;
                  _loc4_ = _loc2_.y;
               }
            }
            _loc2_.cachedVisibility = _loc8_;
            _loc9_++;
         }
         this.healthBar.y = this.hpField.y + HP_FIELD_TO_HP_BAR_OFFSET;
         this._canUseCachedVisibility = true;
         this.layoutExtended(_loc4_ - _loc3_);
      }
      ...
      private function updateVehicleMarkerHover() : void
      {
         ...
         _loc2_ = true;
         if(_loc4_ && !this.actionMarker.isVisible())
         {
            _loc2_ = false;
         }
         if(this._entityType == VehicleMarkersConstants.ENTITY_TYPE_ENEMY)
         {
            ...
            {
               _loc3_ = _loc2_ ? LABEL_COLOR_BLIND_HOVER : LABEL_COLOR_BLIND_HOVER_NO_PING;
            }
            else
            {
               _loc3_ = _loc2_ ? LABEL_ENEMY_HOVER : LABEL_ENEMY_HOVER_NO_PING;
            }
         }
         else if(this._markerSchemeName == SCHEME_NAME_SQUADMAN)
         {
            _loc3_ = _loc2_ ? LABEL_PLATOON_HOVER : LABEL_PLATOON_HOVER_NO_PING;
         }
         else
         {
            _loc3_ = _loc2_ ? LABEL_ALLY_HOVER : LABEL_ALLY_HOVER_NO_PING;
         }
         this.vehicleMarkerHoverMC.gotoAndStop(_loc3_);
      }
      ...
      private function addDamageLabel(param1:*, param2:*) : void
      {
         var _loc5_:TextField = null;
         if(!this._damageAnimState || this.isObserver || !this._isPopulated)
         {
            return;
         }
         var _loc3_:HealthBarAnimatedLabel = param1 ? this.playerHitLabel : this.otherHitLabel;
         var _loc4_:* = _loc3_.damageLabel;
         _loc5_ = _loc4_.tfMap[this.getDamageColor(param1)] as TextField;
         var _loc6_:TextFormat = _loc5_.getTextFormat();
         this.damage.x = -15;
         this.damage.y = this.getDamageLabelOffset();
         var _loc7_:MovieClip = new MovieClip();
         var _loc8_:TextField = new TextField();
         this.damage.addChild(_loc7_);
         ...
         _loc8_.width = 54;
         _loc8_.height = 28;
         _loc8_.defaultTextFormat = _loc6_;
         _loc8_.setTextFormat(_loc6_);
         _loc8_.filters = _loc5_.filters;
         _loc8_.text = String(param2);
         new DamageAnimatedLabel(_loc7_,40);
      }
      
      public function applyExtensionParams(param1:*) : void
      {
         var _loc2_:* = null;
         ...
         var _loc7_:Object = this.vmManager.getExtraConfig();
         if(_loc7_ == null)
         {
            return;
         }
         var _loc8_:Object = _loc7_.componentOverrides;
         if(_loc7_ == null)
         {
            return;
         }
         for(_loc2_ in _loc8_)
         {
            ...
            for(_loc4_ in _loc3_)
            {
               ...
               if(_loc4_ == "shadow")
               {
                  _loc6_ = this.getDropShadowFilter(_loc5_);
                  this[_loc2_].filters = [_loc6_];
               }
               else if(_loc4_ == "textFormat")
               {
                  if(this[_loc2_] is TextField)
                  {
                     this._applyTextFormat(_loc5_,this[_loc2_]);
                  }
                  else
                  {
                     DebugUtils.LOG_WARNING("[AVM]: Can`t apply textformat to an non-textfield object " + getQualifiedClassName(this[_loc2_]));
                  }
               }
               else
               {
                  this[_loc2_][_loc4_] = _loc5_;
               }
            }
         }
         this._damageAnimState = _loc7_.damagaLabelsExtended.enabled;
         if(this._damageAnimState)
         {
            this.removeChild(this.playerHitLabel);
            this.removeChild(this.otherHitLabel);
         }
      }
      
      private function getDamageLabelOffset() : Number
      {
         var _loc1_:Number = -54;
         if(this.playerNameField.visible)
         {
            _loc1_ -= 12;
         }
         if(this.vehicleNameField.visible)
         {
            _loc1_ -= 12;
         }
         if(this.levelIcon.visible)
      ...
      public function getDropShadowFilter(param1:Object) : DropShadowFilter
      {
         var _loc2_:DropShadowFilter = new DropShadowFilter();
         if(param1.hasOwnProperty("distance"))
         {
            _loc2_.distance = param1.distance;
         }
         if(param1.hasOwnProperty("angle"))
         {
            _loc2_.angle = this._clamp(param1.angle,0,360);
         }
         if(param1.hasOwnProperty("color"))
         {
            _loc2_.color = parseInt(param1.color.split("#").join("0x"),16);
         }
         if(param1.hasOwnProperty("alpha"))
         {
            _loc2_.alpha = param1.alpha;
         }
         if(param1.hasOwnProperty("blur"))
         {
            _loc2_.blurX = _loc2_.blurY = this._clamp(param1.blur,0,255);
         }
         if(param1.hasOwnProperty("strength"))
         {
            _loc2_.strength = this._clamp(0.01 * param1.strength,0,255);
         }
         _loc2_.quality = BitmapFilterQuality.MEDIUM;
         _loc2_.inner = false;
      ...
      private function _applyTextFormat(param1:Object, param2:TextField = null) : void
      {
         var _loc3_:* = null;
         var _loc4_:String = null;
         if(param1.hasOwnProperty("targetEntity"))
         {
            _loc4_ = param1["targetEntity"];
            if(this._entityName == "ally" && _loc4_ != "ally")
            {
               return;
            }
            if(this._entityName == "enemy" && _loc4_ != "enemy")
            {
               return;
            }
            if(this._entityName == "squadman" && _loc4_ != "squad")
            {
               return;
            }
         }
         var _loc5_:TextFormat = null;
         if(param1.hasOwnProperty("modify") && Boolean(param1["modify"]))
         {
            _loc5_ = param2.getTextFormat();
         }
         else
         {
         ...
         for(_loc3_ in param1)
         {
            ...
            _loc5_.color = parseInt(param1.color.split("#").join("0x"),16);
         }
         param2.defaultTextFormat = _loc5_;
         param2.setTextFormat(_loc5_);
      }
      
      public function _clamp(param1:Number, param2:Number, param3:Number) : Number
      {
      ...
      private function prepareLayout() : void
      {
         ...
         while(_loc5_ < _loc4_)
         {
            _loc2_ = new VehicleMarkerPart(_loc1_[_loc5_],this.offsets[_loc5_],_loc3_[_loc5_]);
            this.markerParts.push(_loc2_);
            _loc5_++;
         }
